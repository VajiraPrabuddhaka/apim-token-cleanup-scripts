CREATE PROCEDURE WSO2_TOKEN_CLEANUP_SP_ALL
AS
...
SET @backupTables = 'FALSE';    -- SET IF TOKEN TABLE NEEDS TO BACKUP BEFORE DELETE  [DEFAULT : TRUE] , WILL DROP THE PREVIOUS BACKUP TABLES IN NEXT ITERATION
...
SET @rebuildIndexes = 'TRUE'; -- SET TRUE FOR REBUILD INDEXES TO IMPROVE QUERY PERFOMANCE [DEFAULT : FALSE]
SET @updateStats = 'TRUE'; -- SET TRUE FOR GATHER TABLE STATS TO IMPROVE QUERY PERFOMANCE [DEFAULT : FALSE]
